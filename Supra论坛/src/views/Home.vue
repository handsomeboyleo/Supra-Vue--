      ...
      <div class="mui-scroll-wrapper mui-scroll_content">
        <div class="mui-scroll">
          <div class="list-wrapper" v-for="topics in topics" :key="topics._id">
            <div class="headnav">
              <div class="head-icon">
                <img class="head-img" :src="'http://47.101.137.209:8899'+topics.icon" />
              </div>
              <div class="content">
                <div class="user-info">
                  ...
                  <div class="timeAndClickNum">
                    ...
                    <div class="cNum">
                      <img class="img" src="@/assets/icon/评论.png" alt />
                      {{topics.commentNum}}
                    </div>
                  </div>
                </div>
              ...
              <div class="weiboMedia">
                <div class="imgs_content">
                  <div
                    ...
                    :key="index"
                    @click="preview(topics.img_src,index)"
                  >
                    <img class="txt-img" :src="'http://47.101.137.209:8899'+item" />
                  </div>
                </div>
              </div>
            </div>
    ...
    preview(img_src, index) {
      this.$imagePreview({
        images: img_src.map(item => {
          return "http://47.101.137.209:8899" + item;
        }),
        index: index
      });
    }
